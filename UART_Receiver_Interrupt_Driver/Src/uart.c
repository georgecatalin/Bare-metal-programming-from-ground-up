...
void uart3_rx_interrupt_init(void)
{
	 ...
	 *  bit8 PEIE  PE interrupt enable
	 *  bit 7 TXEIE TXE interrupt enable
	 *  bit 6 TCIE Transmission complete interrupt enable
	 *  bit 5 RXNEIE RXNE interrupt enable
	 *   		This bit is set and cleared by software. 0: Interrupt is inhibited. 1: An USART interrupt is generated whenever ORE=1 or RXNE=1 in the USART_SR register
	 * ********************************************************************************************************************************************************************
	 */
